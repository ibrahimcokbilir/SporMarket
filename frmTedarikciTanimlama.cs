...
namespace wf_SporMarket
{
    public partial class frmTedarikciTanimlama : Form
    {
        ...
        private void btnDegistir_Click(object sender, EventArgs e)
        {
            ...
            {
                bs1.EndEdit();
                td.FirmaID = Convert.ToInt32(txtFirmaID.Text);
                td.Unvan = txtUnvan.Text;
                td.Yetkili = txtYetkili.Text;
                td.Telefon = txtTelefon.Text;
                td.Adres = txtAdres.Text;
        ...
        {
            txtFirmaID.Text = lvTedarikciler.SelectedItems[0].SubItems[0].Text;
            txtUnvan.Text = lvTedarikciler.SelectedItems[0].SubItems[1].Text;
            txtYetkili.Text = lvTedarikciler.SelectedItems[0].SubItems[2].Text;
            txtTelefon.Text = lvTedarikciler.SelectedItems[0].SubItems[3].Text;
            txtAdres.Text = lvTedarikciler.SelectedItems[0].SubItems[4].Text;
            txtil.Text = lvTedarikciler.SelectedItems[0].SubItems[5].Text;
            txtilce.Text = lvTedarikciler.SelectedItems[0].SubItems[6].Text;
            txtVergiNo.Text = lvTedarikciler.SelectedItems[0].SubItems[7].Text;
            txtVergiDairesi.Text = lvTedarikciler.SelectedItems[0].SubItems[8].Text;
            btnDegistir.Enabled = true;
            btnSil.Enabled = true;
            btnKaydet.Enabled = false;
